...
const CALL_FOR: Record<string, string[]> = {
  ...
  YUE: ['失去意識或無反應','停止呼吸或嚴重呼吸困難','嚴重胸痛或胸部壓迫感','疑似中風（面部下垂、手臂無力、言語不清）','無法止住嘅大量出血','疑似脊椎受傷 — 請勿移動傷者','中毒或藥物過量','溺水或嚴重燒傷'],
}
