...
const OPTIONS = [
  ...
  },
  {
    ...
    items: {
      ...
      YUE: ['可調劑處方藥', '更廣泛嘅非處方藥選擇', '可諮詢藥劑師', '常見於東京、大阪、名古屋'],
    },
  },
  {
    ...
    items: {
      ...
      YUE: ['僅在就診後可用', '僅限處方藥', '喺救急病院（急救醫院）提供'],
    },
  },
]

const PACKAGING = [
  { jp: '用法・用量', meaning: { EN: 'Dosage instructions', JP: '用法・用量', ZH: '用法用量', 'ZH-T': '用法用量', KO: '용법·용량', ES: 'Instrucciones de dosificación', FR: 'Posologie', IT: 'Istruzioni per il dosaggio', TL: 'Mga tagubilin sa dosis', ID: 'Petunjuk penggunaan', DE: 'Dosierungsanleitung', PT: 'Instruções de dosagem', RU: 'Инструкция по применению', YUE: '用法·用量' } },
  { jp: '成分', meaning: { EN: 'Active ingredients', JP: '有効成分', ZH: '成分', 'ZH-T': '成分', KO: '성분', ES: 'Ingredientes activos', FR: 'Ingrédients actifs', IT: 'Ingredienti attivi', TL: 'Mga aktibong sangkap', ID: 'Bahan aktif', DE: 'Wirkstoffe', PT: 'Ingredientes ativos', RU: 'Активные вещества', YUE: '有效成分' } },
  { jp: '使用上の注意', meaning: { EN: 'Warnings / precautions', JP: '注意事項', ZH: '注意事项', 'ZH-T': '注意事項', KO: '경고·주의사항', ES: 'Advertencias / precauciones', FR: 'Avertissements / précautions', IT: 'Avvertenze / precauzioni', TL: 'Mga babala / pag-iingat', ID: 'Peringatan / tindakan pencegahan', DE: 'Warnhinweise / Vorsichtsmaßnahmen', PT: 'Advertências / precauções', RU: 'Предупреждения / меры предосторожности', YUE: '警告 / 注意事項' } },
  { jp: '15歳以上', meaning: { EN: 'For ages 15 and above', JP: '15歳以上対象', ZH: '15岁及以上适用', 'ZH-T': '15歲及以上適用', KO: '만 15세 이상', ES: 'Para mayores de 15 años', FR: 'Pour les 15 ans et plus', IT: 'Per età 15 anni e oltre', TL: 'Para sa 15 taong gulang pataas', ID: 'Untuk usia 15 tahun ke atas', DE: 'Ab 15 Jahren', PT: 'Para maiores de 15 anos', RU: 'Для лиц от 15 лет', YUE: '適用於15歲及以上' } },
  { jp: '授乳中', meaning: { EN: 'While breastfeeding (often a warning)', JP: '授乳中（注意表示が多い）', ZH: '哺乳期间（常为警告）', 'ZH-T': '哺乳期間（常為警告）', KO: '수유 중 (주로 경고)', ES: 'Durante la lactancia (suele ser una advertencia)', FR: "Pendant l'allaitement (souvent un avertissement)", IT: "Durante l'allattamento (spesso un avviso)", TL: 'Habang nagpapasuso (madalas na babala)', ID: 'Selama menyusui (sering berupa peringatan)', DE: 'Während der Stillzeit (oft eine Warnung)', PT: 'Durante amamentação (frequentemente um aviso)', RU: 'Во время грудного вскармливания (часто предупреждение)', YUE: '哺乳期間（常為警告）' } },
]
