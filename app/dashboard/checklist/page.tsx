...
const SECTIONS = [
  ...
  { key: 'medical', icon: 'medical_information', color: '#206777', items: [
    ...
    },
    {
      ...
      note: { EN: 'A, B, O, or AB', JP: 'A・B・O・AB型', ZH: 'A、B、O或AB型', 'ZH-T': 'A、B、O或AB型', KO: 'A, B, O, 또는 AB형', ES: 'A, B, O o AB', FR: 'A, B, O ou AB', IT: 'A, B, O o AB', TL: 'A, B, O, o AB', ID: 'A, B, O, atau AB', DE: 'A, B, O oder AB', PT: 'A, B, O ou AB', RU: 'A, B, O или AB', YUE: 'A、B、O或AB型' },
    },
  ]},
