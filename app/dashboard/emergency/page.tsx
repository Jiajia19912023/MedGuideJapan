...
const WHEN: Array<{ label: Record<string, string>; urgent: boolean }> = [
  ...
  { urgent: false, label: { EN: 'Mild fever (under 38.5°C)', JP: '軽度の発熱（38.5℃未満）', ZH: '轻微发烧（38.5°C以下）', 'ZH-T': '輕微發燒（38.5°C以下）', KO: '가벼운 열 (38.5°C 미만)', ES: 'Fiebre leve (menos de 38.5°C)', FR: 'Fièvre légère (moins de 38,5°C)', IT: 'Febbre lieve (sotto 38,5°C)', TL: 'Banayad na lagnat (wala pang 38.5°C)', ID: 'Demam ringan (di bawah 38,5°C)', DE: 'Leichtes Fieber (unter 38,5°C)', PT: 'Febre leve (abaixo de 38,5°C)', RU: 'Умеренная температура (ниже 38,5°C)' } },
