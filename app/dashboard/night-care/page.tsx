...
const HOW_STEPS: Record<string, string[]> = {
  ...
  YUE: ['致電#7119 — 護士會提供建議並推薦最近嘅設施。','喺谷歌地圖搜索：「夜間救急クリニック ＋ 你嘅城市」','查看你所在城市嘅官方網站，了解值班醫院（輪番病院）列表。','詢問你酒店／大廈嘅禮賓部 — 佢哋通常有當地列表。'],
}
...
const BRING_ITEMS: Record<string, string[]> = {
  ...
  YUE: ['健康保險證（保険証）','在留卡 / 護照','現金（¥5,000〜¥15,000）','當前用藥清單','準備好翻譯應用嘅手機'],
}
