...
const CAT_LABELS: Record<string, Record<string, string>> = {
  arrival:     { EN: 'At Reception', JP: '受付で', ZH: '前台', 'ZH-T': '前台', KO: '접수처', ES: 'En Recepción', FR: 'À la Réception', IT: 'All\'Accettazione', TL: 'Sa Reception', ID: 'Di Resepsionis', DE: 'Am Empfang', PT: 'Na Recepção', RU: 'На стойке регистрации' },
  symptoms:    { EN: 'Describing Symptoms', JP: '症状の説明', ZH: '描述症状', 'ZH-T': '描述症狀', KO: '증상 설명', ES: 'Describir Síntomas', FR: 'Décrire les Symptômes', IT: 'Descrivere Sintomi', TL: 'Paglalarawan ng Sintomas', ID: 'Menjelaskan Gejala', DE: 'Symptome Beschreiben', PT: 'Descrever Sintomas', RU: 'Описание симптомов' },
  body:        { EN: 'Body Parts', JP: '身体の部位', ZH: '身体部位', 'ZH-T': '身體部位', KO: '신체 부위', ES: 'Partes del Cuerpo', FR: 'Parties du Corps', IT: 'Parti del Corpo', TL: 'Mga Bahagi ng Katawan', ID: 'Bagian Tubuh', DE: 'Körperteile', PT: 'Partes do Corpo', RU: 'Части тела' },
  appointment: { EN: 'Appointments', JP: '予約', ZH: '预约', 'ZH-T': '預約', KO: '예약', ES: 'Citas', FR: 'Rendez-vous', IT: 'Appuntamenti', TL: 'Mga Appointment', ID: 'Janji', DE: 'Termine', PT: 'Consultas', RU: 'Запись на приём' },
  pharmacy:    { EN: 'At the Pharmacy', JP: '薬局で', ZH: '药局', 'ZH-T': '藥局', KO: '약국', ES: 'En la Farmacia', FR: 'À la Pharmacie', IT: 'In Farmacia', TL: 'Sa Parmasya', ID: 'Di Apotek', DE: 'In der Apotheke', PT: 'Na Farmácia', RU: 'В аптеке' },
  emergency:   { EN: 'Emergency', JP: '緊急フレーズ', ZH: '紧急情况', 'ZH-T': '緊急情況', KO: '응급 상황', ES: 'Emergencia', FR: 'Urgence', IT: 'Emergenza', TL: 'Emerhensya', ID: 'Darurat', DE: 'Notfall', PT: 'Emergência', RU: 'Экстренно' },
}
...
const TIP_LABEL = { EN: 'Tip: ', JP: 'ヒント：', ZH: '提示：', 'ZH-T': '提示：', KO: '팁: ', ES: 'Consejo: ', FR: 'Conseil : ', IT: 'Suggerimento: ', TL: 'Tip: ', ID: 'Tips: ', DE: 'Tipp: ', PT: 'Dica: ', RU: 'Совет: ' }
